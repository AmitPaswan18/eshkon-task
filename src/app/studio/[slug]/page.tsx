  ...
  sections: [
    {
      ...
      props: {
        ...
        subtitle: 'A powerful, schema-driven editor for high-performance landing pages.',
    ...
    },
    {
      ...
      props: {
        ...
        features: [
          { title: 'Schema Driven', description: 'Everything is validated with Zod for total safety.' },
          { title: 'Redux State', description: 'Undo, redo, and state persistence out of the box.' },
          { title: 'A11y First', description: 'WCAG 2.2 AAA standards implemented by default.' },
        ],
        textColor: '#000000',
  ...
  if (role === 'viewer') {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-slate-50">
        ...
        <p className="text-slate-500">Viewers do not have access to the Studio.</p>
        <button 
